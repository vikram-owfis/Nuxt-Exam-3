        ...
        >
          ...
          >
            ...
            >
              <div>
                ...
                <div class="mt-3 sm:mt-5">
                  <DialogTitle
                    ...
                    >Update lead details</DialogTitle
                  >
                  <div class="mt-2">
                    <div class="mt-2 mb-3">
                    ...
                    <div class="mt-2 mb-3">
                      ...
                      <div class="mt-2.5">
                        ...
                        >
                          ...
                          <option value="Hot Interest">Hot Interest</option>
              ...
              <!-- add lead button starts here -->
              <div class="mt-5 sm:mt-6">
                <button
                  type="button"
                  class="inline-flex w-full justify-center rounded-md bg-slate-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  @click="updateSelectedLead"
                >
                  update lead
                </button>
              </div>
              <!-- add lead button ends here -->
            </DialogPanel>
          </TransitionChild>
        </div>
      </div>
...
const emits = defineEmits(["updateLead", "closeModal"]);
//define emits ends here

//props schema starts here (here iam using only this propeties if u want you can add them into schema)
interface updateLeadSchema {
  selectedLead: {
    name: string;
    status: string;
    phone_number: string;
...
//defining props
const props = defineProps<updateLeadSchema>();

//lead details
const updateLead: any = ref({
  name: props.selectedLead.name,
  phone_number: props.selectedLead.phone_number,
  email: props.selectedLead.email,
  address: props.selectedLead.address,
  status:props.selectedLead.status,
  uid:props.selectedLead.uid
});

//emiting the updated lead starts here
const updateSelectedLead = () => {
  emits("updateLead", updateLead);
  open.value = false;
};
//emitting the updated lead ends here
</script>